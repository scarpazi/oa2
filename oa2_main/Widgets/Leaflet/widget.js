...
WAF.define('Leaflet', ['waf-core/widget'], function (widget) {
    ...
    var Leaflet = widget.create('Leaflet', {
        ...
        lat:  widget.property({ type: 'number', defaultValue: 41.5294232 }),
        lan:  widget.property({ type: 'number', defaultValue: 15.1587614 }),
...
this._map.addControl(new L.Control.Draw({
    ...
    var castles = L.geoJson( castelli, {
      ...
      var citylimits = L.geoJson( comunidipuglia, {  style: function (feature) {
   ...
   L.control.layers(baseLayers, overlays).addTo(this._map);
